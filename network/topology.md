...
| `gw.${DOMAIN}`     | 192.168.10.1  | Passerelle / Routeur     | Gateway LAN, garde l'entrée  |
| `media.${DOMAIN}`  | 192.168.10.20 | Hub multimédia           | Serveur multimédia du lab    |
| `host1.${DOMAIN}`  | 192.168.10.10 | Filtrage & Reverse Proxy | Hôte Docker principal        |
...
| Traefik  | https://traefik.${DOMAIN}      | 80 / 443   | Reverse proxy, dashboard       |
| AdGuard  | https://adguard.${DOMAIN}      | —          | DNS, bloqueur pub              |
| Squid    | —                              | 3128       | Proxy HTTP/HTTPS, cache        |
...
| LAN ${DOMAIN}   | 192.168.10.0/24   | Réseau physique du lab                     |
